      ...
      <div className="node-card rounded-xl bg-white shadow-sm border transition-all">
        ...
        <div className="px-3 pt-3 pb-2 border-b border-gray-100">
          <Dropdown>
            ...
            >
              <span className={`text-sm truncate ${questionId ? 'text-gray-950' : 'text-gray-400'}`}>
        ...
        <div className="flex">
          <button
            ...
            onMouseDown={stopProp}
            disabled
            className="node-tab node-tab-yes flex-1 py-2 text-sm font-medium rounded-bl-xl transition-colors"
          >
            Oui
          </button>
          ...
          <button
            ...
            onMouseDown={stopProp}
            disabled
            className="node-tab node-tab-no flex-1 py-2 text-sm font-medium rounded-br-xl transition-colors"
          >
            Non
          </button>
        </div>
